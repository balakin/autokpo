...
### Requirement: Icons are rendered via react-icons FA6 components

The system SHALL import icon components from `react-icons/fa6` (e.g., `FaPencil`, `FaPlus`). No other icon libraries (including `@iconify/react`) SHALL be used. No ad-hoc inline SVGs SHALL be used.
