...
Ensure Husky git hooks are not installed in CI/CD environments, preventing hook interference during automated workflows such as dependency installation and release commits.
