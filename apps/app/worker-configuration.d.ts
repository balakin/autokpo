/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3e331a264ca8067816e91afd1e3237c4)
// Runtime types generated with workerd@1.20260825.1 2026-04-23 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	SYNC_RATE_LIMITER: RateLimit;
	E2EE_RATE_LIMITER: RateLimit;
	EXCHANGE_RATES_RATE_LIMITER: RateLimit;
	AUTH_RATE_LIMITER: RateLimit;
	APP_URL: "https://app.autokpo.com" | "http://localhost:5173";
	RESEND_FROM_EMAIL: "AutoKPO <noreply@notify.autokpo.com>" | "AutoKPO <autokpo@resend.dev>";
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		EXCHANGE_RATES_RATE_LIMITER: RateLimit;
		AUTH_RATE_LIMITER: RateLimit;
		APP_URL: "https://app.autokpo.com";
		RESEND_FROM_EMAIL: "AutoKPO <noreply@notify.autokpo.com>";
		BETTER_AUTH_SECRET: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		GITHUB_CLIENT_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "RESEND_FROM_EMAIL" | "BETTER_AUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "RESEND_API_KEY" | "TURNSTILE_SECRET_KEY">> {}
}
