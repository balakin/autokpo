...
The system SHALL render an "Uredi" button in the signature preview card header. Pressing the button SHALL open a modal containing the SignatureForm.

#### Scenario: Edit button opens modal

- **WHEN** the user clicks "Uredi" on the signature preview card
