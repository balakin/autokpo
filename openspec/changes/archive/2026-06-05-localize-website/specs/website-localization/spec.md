...
The system SHALL provide static localized landing pages for Serbian Latin, English, and Russian using Astro i18n routing with Serbian Latin as the default unprefixed locale.
...
- **THEN** the build generates static output for `/`, `/en/`, and `/ru/` without requiring `output: "server"`
