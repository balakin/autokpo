...
6. **Licenca** (icon: `LuShield`) — One list item: "AGPL-3.0" link to `https://github.com/balakin/autokpo` with subtitle "GNU Affero General Public License v3.0"
...
- **THEN** an "AGPL-3.0" link to `https://github.com/balakin/autokpo` SHALL be present
